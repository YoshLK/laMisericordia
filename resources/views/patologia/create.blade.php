        ...
        <div class="modal-body">
          <h5 class="modal-title bg-success col-md-7" > Datos de la patologia</h5>
                ...
                <div class="form-group col-md">
                  ...
                  <input type="text" name="nombre_patologia" class="form-control"  placeholder="Ingresar el nombre de la patologia" required="true">
                </div>
              </div>
              <div class="form-row ">
                <div class="form-group col-md">
                  ...
                  <div class="form-row ">
                    ...
                    <textarea class="form-control" name="notas_patologia" rows="10"  placeholder="Información adicional relevante sobre la patología, síntomas, resultados o recomendaciones médicas."></textarea>
                  </div>
        </div>
