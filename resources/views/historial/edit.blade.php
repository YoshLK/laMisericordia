<div class="modal fade" id="editHistorial{{ $adulto->historialDatos->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="POST" action="{{ route('historial.update', $adulto->historialDatos->id) }}" enctype="multipart/form-data">
          @csrf
          {{method_field('PATCH')}}
        <div class="modal-body">
          <h6 class="modal-title bg-success text-white col-md-7" >MEDIDAS CORPORALES</h6>
                ...
                <div class="form-group col-md">
                  <label>Peso (kg)</label>
                  <input type="text" name="peso" class="form-control" value="{{ $adulto->historialDatos->peso}}"  placeholder="Ingresar el peso del adulto mayor" required="true">
                </div>
                <div class="form-group col-md">
                ...
                <div class="form-row ">
                      ...
                      <input type="text" name="piernas" class="form-control"  value="{{ $adulto->historialDatos->piernas}}"  placeholder="Ingresar la talla de pantalon" required="true">
                  </div>
                  <div class="form-row ">
                    <label>Calzado</label>
                    <input type="text" name="calzado" class="form-control"  value="{{ $adulto->historialDatos->calzado}}"  placeholder="Ingresar la talla de calzado" required="true">
                </div>
                <br>
                  <div class="form-row ">
