<div class="modal fade" id="createHistorial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h6 class="modal-title bg-info text-white col-md-7" >MEDIDAS CORPORALES</h6>
                ...
                <div class="form-group col-md">
                  <label>Peso (kg)</label>
                  <input type="text" name="peso" class="form-control"  placeholder="Ingresar el peso del adulto mayor" required="true">
                </div>
                <div class="form-group col-md">
                    <label>Altura (cm)</label>
                    <input type="text" name="altura" class="form-control"  placeholder="Ingresar la altura del adulto mayor" required="true">
                </div>
              </div>
                ...
                <div class="form-row ">
                      ...
                      <input type="text" name="piernas" class="form-control"  placeholder="Ingresar la talla de pantalon" required="true">
                  </div>
                  <div class="form-row ">
                    <label>Calzado</label>
                    <input type="text" name="calzado" class="form-control"  placeholder="Ingresar la talla de calzado" required="true">
                </div>
                <br>
                  <div class="form-row ">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">Añadir Ficha Corporal</button>
